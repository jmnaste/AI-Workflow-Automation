# UI Design System (Emulation-first)
...
- Logo path: reference "/images/Flovify-logo.png" (repo root) or copy into UI public for app-relative serving
- Favicon: generate from the logo (see ui/branding.md) and place in `images/favicon/`
