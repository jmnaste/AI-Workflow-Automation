...
- Development (Vite): consider copying the logo into `webui/public/` for static serving at the app base path. Alternatively, import the image via bundler if tree-shaking desired.
